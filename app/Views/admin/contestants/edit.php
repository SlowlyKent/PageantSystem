...
<div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div>
        <h1 class="h2"><i class="bi bi-pencil-square"></i> Edit Contestant</h1>
        <p class="text-muted">Update contestant information</p>
    </div>
...
<div class="card shadow-sm">
    <div class="card-body p-4">
        <form action="<?= base_url('admin/contestants/update/' . $contestant['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input 
                        ...
                        id="first_name" 
                        name="first_name" 
                        value="<?= old('first_name', $contestant['first_name']) ?>"
                        required
                    >
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input 
                        ...
                        id="middle_name" 
                        name="middle_name" 
                        value="<?= old('middle_name', $contestant['middle_name']) ?>"
                    >
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input 
                        ...
                        id="last_name" 
                        name="last_name" 
                        value="<?= old('last_name', $contestant['last_name']) ?>"
                        required
                    >
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input 
                        ...
                        id="birthdate" 
                        name="birthdate" 
                        value="<?= old('birthdate', $contestant['birthdate']) ?>"
                        required
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input 
                        ...
                        id="height" 
                        name="height" 
                        value="<?= old('height', $contestant['height']) ?>"
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input 
                        ...
                        id="weight" 
                        name="weight" 
                        value="<?= old('weight', $contestant['weight']) ?>"
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea 
                        ...
                        rows="2" 
                        required
                    ><?= old('address', $contestant['address']) ?></textarea>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input 
                        ...
                        id="city" 
                        name="city" 
                        value="<?= old('city', $contestant['city']) ?>"
                        required
                    >
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input 
                        ...
                        id="province" 
                        name="province" 
                        value="<?= old('province', $contestant['province']) ?>"
                        required
                    >
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input 
                        ...
                        id="contact_number" 
                        name="contact_number" 
                        value="<?= old('contact_number', $contestant['contact_number']) ?>"
                        required
                    >
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input 
                        ...
                        id="email" 
                        name="email" 
                        value="<?= old('email', $contestant['email']) ?>"
                    >
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input 
                                ...
                                id="talent" 
                                name="talent" 
                                value="<?= old('talent', $contestant['talent']) ?>"
                            >
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="status" name="status">
                                ...
                                <option value="inactive" <?= old('status', $contestant['status']) === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                                <option value="disqualified" <?= old('status', $contestant['status']) === 'disqualified' ? 'selected' : '' ?>>Disqualified</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea 
                        ...
                        name="advocacy" 
                        rows="3"
                    ><?= old('advocacy', $contestant['advocacy']) ?></textarea>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea 
                        ...
                        name="hobbies" 
                        rows="3"
                    ><?= old('hobbies', $contestant['hobbies']) ?></textarea>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea 
                        ...
                        name="education" 
                        rows="3"
                    ><?= old('education', $contestant['education']) ?></textarea>
                </div>
            </div>
