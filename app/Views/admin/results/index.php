...
<div class="row mb-4">
    <div class="col-md-4">
        <div class="card overall-card" onclick="window.location.href='<?= base_url('admin/results/overall') ?>'">
            <div class="card-body text-center">
                <i class="bi bi-trophy-fill icon-display-lg icon-gold"></i>
    ...
    <div class="col-md-4">
        <div class="card result-card result-card-primary">
            <div class="card-body text-center">
                <i class="bi bi-people-fill icon-display-lg text-primary"></i>
    ...
    <div class="col-md-4">
        <div class="card result-card result-card-success">
            <div class="card-body text-center">
                <i class="bi bi-award-fill icon-display-lg text-success"></i>
                ...
                <div class="card result-card result-card-primary">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <i class="bi bi-award result-card-icon"></i>
                        </div>
                        <div class="mt-3">
